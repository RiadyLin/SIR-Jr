   ...
   private void saveData() {
        if (option.equals("NEW")) {
            ...
            if (AppUtil.getService().save(purchaserequest)) {
                ...
                login.setEmployeeRecordId(purchaserequest.getRecordId());
...
//                login.setAccessRecordId(mapAccess.get(cbStatus.getSelectedItem().toString()));
                ...
                if (AppUtil.getService().save(login)) {
                    ...
                    if (AppUtil.getService().delete(purchaserequest)) {
                        msg("Save Failed!");
                    }
                }
            ...
            purchaserequest.setEditByUserRecordId(Main.getFrame().getLogin().getEmployeeRecordId());
            purchaserequest.setEditDatetime(new Date());
            if (AppUtil.getService().save(purchaserequest)) {
